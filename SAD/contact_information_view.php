...
$sql = 'SELECT *
		FROM contact_information'; //table name
...
<body class="neon">
    ...
    <section>
        <div class="container" data-aos="flip-up">
            <br>
            <br>
            <h1>Students Contact Information</h1>
            <div class="back">
          ...
          ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info btn-sm" href="contact_information_indiView.php?Stu_id=<?php echo $row['Stu_id']; ?>">View</a>
                            <a class="btn btn-success btn-sm" href="contact_edit.php?Stu_id=<?php echo $row['Stu_id']; ?>">Edit</a>
                            <a class="btn btn-danger btn-sm" href="contact_delete.php?Stu_id=<?php echo $row['Stu_id']; ?>" onclick="return confirm('Are You sure?')">Delete</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
