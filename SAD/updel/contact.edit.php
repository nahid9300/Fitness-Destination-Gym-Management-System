...
$sql="UPDATE contact_information SET Student_name='$Student_name',Height='$Height',Joining_weight='$Joining_weight', Present_weight='$Present_weight', Desire_weight='$Desire_weight' WHERE Stu_id=$Stu_id";
