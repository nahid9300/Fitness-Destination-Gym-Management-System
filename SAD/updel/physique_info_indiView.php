        ...
        <div class="col-md-8">
          ...
          <table class="table">
            <tr>
              ...
              <td><?php echo $physique_information['Stu_id'];?></td>
            </tr>
            <tr>
              <th class="text-right">Student name:</th>
              <td><?php echo $physique_information['Student_name'];?></td>
            </tr>
            <tr>
              <th class="text-right">Height:</th>
              <td><?php echo $physique_information['Height'];?></td>
            </tr>
            <tr>
              <th class="text-right">Joining weight:</th>
              <td><?php echo $physique_information['Joining_weight'];?></td>
            </tr>
            <tr>
              <th class="text-right">Present weight:</th>
              <td><?php echo $physique_information['Present_weight'];?></td>
            </tr>
            <tr>
              <th class="text-right">Desire weight:</th>
              <td><?php echo $physique_information['Desire_weight'];?></td>
            </tr>
          </table>
        </div>
      </div>
