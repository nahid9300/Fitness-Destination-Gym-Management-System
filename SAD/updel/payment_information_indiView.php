        ...
        <div class="col-md-8">
          ...
          <table class="table">
            <tr>
              ...
              <td><?php echo $payment_information['Payment_id'];?></td>
            </tr>
            <tr>
              <th class="text-right">Student id:</th>
              <td><?php echo $payment_information['Student_id'];?></td>
            </tr>
            <tr>
              <th class="text-right">Student name:</th>
              <td><?php echo $payment_information['Student_Name'];?></td>
            </tr>
            <tr>
              <th class="text-right">Payment Date:</th>
              <td><?php echo $payment_information['Payment_Date'];?></td>
            </tr>
            <tr>
              <th class="text-right">Payment_month:</th>
              <td><?php echo $payment_information['Payment_month'];?></td>
            </tr>
            <tr>
              <th class="text-right">Amount:</th>
              <td><?php echo $payment_information['Amount'];?></td>
            </tr>
            <tr>
              <th class="text-right">Due:</th>
              <td><?php echo $payment_information['Due'];?></td>
            </tr>
          </table>
        </div>
      </div>
