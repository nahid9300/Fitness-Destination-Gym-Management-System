            ...
            <div class="col-md-8">
                ...
                <table class="table">
                    <tr>
                        ...
                        <td>
                            <?php echo $student_information['Stu_id'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Student name:</th>
                        <td>
                            <?php echo $student_information['Student_name'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Fathers name:</th>
                        <td>
                            <?php echo $student_information['Fathers_name'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Date of birth:</th>
                        <td>
                            <?php echo $student_information['Date_of_Birth'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Sex:</th>
                        <td>
                            <?php echo $student_information['Sex'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Martial status:</th>
                        <td>
                            <?php echo $student_information['Martial_status'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Surgery:</th>
                        <td>
                            <?php echo $student_information['Surgery'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Health:</th>
                        <td>
                            <?php echo $student_information['Health'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Joining date:</th>
                        <td>
                            <?php echo $student_information['Joining_date'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Exit date:</th>
                        <td>
                            <?php echo $student_information['Exit_date'];?>
                        </td>
                    </tr>
                </table>
