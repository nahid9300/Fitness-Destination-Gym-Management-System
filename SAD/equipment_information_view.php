...
$sql = 'SELECT * 
		FROM equipment_information'; //table name
...
<head>
    <title>Student equipment information</title>
...
<body class="neon">
    ...
    <section>
        <div class="container" data-aos="flip-up">
            ...
            <div class="insert">
                <a class="btn btn-success" href="equipment_information_form.php">Insert Equipment</a>
            </div>
            <!--table name-->
          ...
          ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info btn-sm" href="equipment_information_indiView.php?Equipment_id=<?php echo $row['Equipment_id']; ?>">View</a>
                            <a class="btn btn-success btn-sm" href="equipment_information_edit.php?Equipment_id=<?php echo $row['Equipment_id']; ?>">Edit</a>
                            <a class="btn btn-danger btn-sm" href="equipment_information_delete.php?Equipment_id=<?php echo $row['Equipment_id']; ?>" onclick="return confirm('Are You sure?')">Delete</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
