            ...
            <div class="col-md-8">
                ...
                <table class="table">
                    <tr>
                        ...
                        <td>
                            <?php echo $contact_information['Stu_id'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Student name:</th>
                        <td>
                            <?php echo $contact_information['Student_name'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Cell:</th>
                        <td>
                            <?php echo $contact_information['Cell'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Telephone:</th>
                        <td>
                            <?php echo $contact_information['Telephone'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Present address:</th>
                        <td>
                            <?php echo $contact_information['Present_address'];?>
                        </td>
                    </tr>
                    <tr>
                        <th class="text-right">Permanent address:</th>
                        <td>
                            <?php echo $contact_information['Permanent_address'];?>
                        </td>
                    </tr>
                </table>
