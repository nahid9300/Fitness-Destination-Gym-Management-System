        ...
        <div class="col-md-8">
          ...
          <table class="table">
            ...
            <tr>
              ...
              <td><input type="Date" name="Payment_Date" value="<?php echo $payment_information ['Payment_Date']?>" class="form-control"></td>
            </tr>
            <tr>
              <th class="text-right">Payment month</th>
              <td><input type="text" name="Payment_month" value="<?php echo $payment_information['Payment_month']?>" class="form-control"></td>
            </tr>
            <tr>
              <th class="text-right">Amount:</th>
              <td><input type="int" name="Amount" value="<?php echo $payment_information['Amount']?>" class="form-control"></td>
            </tr>
            <tr>
              <th class="text-right">Due:</th>
              <td><input type="int" name="Due" value="<?php echo $payment_information['Due']?>" class="form-control"></td>
            </tr>
            <tr>
