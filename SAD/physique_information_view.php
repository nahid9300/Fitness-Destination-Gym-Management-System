...
$sql = 'SELECT * 
		FROM physique_information'; //table name
...
<head>
    <title>Student physique information</title>
        ...
        <div class="container" data-aos="flip-up">
            ...
            <table class="table table-striped table-dark text-center" ,>
                <thead>
                    <tr>
                        ...
                        <th scope="col">Joining weight</th>
                        <th scope="col">Present weight</th>
                        <th scope="col">Desire weight</th>
          ...
          ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info btn-sm" href="physique_info_indiView.php?Stu_id=<?php echo $row['Stu_id']; ?>">View</a>
                            <a class="btn btn-success btn-sm" href="physique_edit.php?Stu_id=<?php echo $row['Stu_id']; ?>">Edit</a>
                            <a class="btn btn-danger btn-sm" href="physique_delete.php?Stu_id=<?php echo $row['Stu_id']; ?>" onclick="return confirm('Are You sure?')">Delete</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
